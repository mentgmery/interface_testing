...
class DataCleaningReceiver(OpenURL):
    ...
    def get_dataclean_receiver_datalist_url(self,data):
        ...
        if data is None:
            url = tmo_url + '&ENV_OUTPUT_TEMPLATE_LIST={}'
            return url
        else:
            url = tmo_url + '&ENV_OUTPUT_TEMPLATE_LIST=' + str(data)
            return url
    ...
    def get_dataclean_receiver_datadetails_url(self,data):
        ...
        if data is None:
            url = tmo_url + '&ENV_OUTPUT_DATA_DETAIL={}'
            return url
        else:
            url = tmo_url + '&ENV_OUTPUT_DATA_DETAIL=' + str(data)
            return url
    ...
    def get_template_list_url(self,data):
        ...
        if data is None:
            url = dso_url + '&ENV_OUTPUT_DATA_LIST={}'
            return url
        else:
            url = dso_url + '&ENV_OUTPUT_DATA_LIST=' + str(data)
            return url
    ...
    def get_template_details_url(self,data):
        ...
        if data is None:
            url = dso_url + '&ENV_OUTPUT_DATA_DETAIL={}'
            return url
        else:
            url = dso_url + '&ENV_OUTPUT_DATA_DETAIL=' + str(data)
            return url
